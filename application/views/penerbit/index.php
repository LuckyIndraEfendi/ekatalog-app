...
base_url("penerbit/detail/{$data['id']}")?>">Detail</a>
...
base_url("penerbit/hapus/{$data['id']}")?>">Hapus</a>
</div>
            </td>
        </tr>
    <?php
...
<!-- <a class="btn btn-warning btn-sm" href="<?= base_url("penerbit/detail/{$data['id']}")?>">Detail</a>
                <a class="btn btn-primary btn-sm" href="<?= base_url("penerbit/form/{$data['id']}")?>">Edit</a>
